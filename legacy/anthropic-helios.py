...
# Claude Haiku 4.5      claude-haiku-4-5-20251001    (Lightning-fast with extended thinking)
# Claude Haiku 3.5      claude-3-5-haiku-20241022
# Claude Opus 4.1       claude-opus-4-1-20250805     (Exceptional for specialized complex tasks)
...
def calculate_subagent_cost(model, input_tokens, output_tokens):
    # Pricing information per model (as of October 2025)
    pricing = {
        # Latest models (Oct 2025)
        "claude-sonnet-4-5-20250929": {"input_cost_per_mtok": 3.00, "output_cost_per_mtok": 15.00},
        "claude-sonnet-4-20250514": {"input_cost_per_mtok": 3.00, "output_cost_per_mtok": 15.00},
        "claude-3-7-sonnet-20250219": {"input_cost_per_mtok": 3.00, "output_cost_per_mtok": 15.00},
        "claude-haiku-4-5-20251001": {"input_cost_per_mtok": 1.00, "output_cost_per_mtok": 5.00},
        "claude-3-5-haiku-20241022": {"input_cost_per_mtok": 0.80, "output_cost_per_mtok": 4.00},
        "claude-opus-4-1-20250805": {"input_cost_per_mtok": 15.00, "output_cost_per_mtok": 75.00},
        "claude-opus-4-20250514": {"input_cost_per_mtok": 15.00, "output_cost_per_mtok": 75.00},
        # Legacy models
