# Helios - A Framework for Claude Opus to Orchestrate Subagents
...
- Add support for GPT-4 as an orchestrator in anthropic_openai-helios.py
  Simply

```bash
python anthropic_openai-helios.py
```
